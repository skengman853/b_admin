...
class DocumentFinancialFact(Base):
    ...
    total_due: Mapped[Decimal | None] = mapped_column()
    settlement_discount_total: Mapped[Decimal | None] = mapped_column()
    arithmetic_mode: Mapped[str | None] = mapped_column(String(20))
    arithmetic_status: Mapped[str | None] = mapped_column(String(20))
    arithmetic_delta: Mapped[Decimal | None] = mapped_column()
