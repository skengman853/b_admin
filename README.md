...
- bookkeeper handover, business context & meeting questions (latest): [docs/28-bookkeeper-handover-context.md](docs/28-bookkeeper-handover-context.md)
- the operating cycle — how the system is used: [docs/26-operating-cycle.md](docs/26-operating-cycle.md)
